...
cc -m32 -msse -O0 -no-pie *.o att32c.c -o att32 -lm
...
rm *.o
rm *.txt
cc -m32 -msse -O0 -no-pie -fopenmp ../attention_mechanism_32/*.o att32_omp.c -o att32_omp -lm
# cc -m32 -msse -O0 -no-pie -fopenmp att32_omp.c -o att32_omp -lm
...
cc -m32 -msse -O0 -no-pie att32c.c -o att32 -lm
...
cc -m64 -msse -mavx -O0 -no-pie *.o att64c.c -o att64 -lm
...
rm *.o
rm *.txt
cc -m64 -msse -mavx -O0 -no-pie -fopenmp ../attention_mechanism_64/*.o  att64_omp.c -o att64_omp -lm
# cc -m64 -msse -mavx -O0 -no-pie -fopenmp att64_omp.c -o att64_omp -lm
...
cc -m64 -msse -mavx -O0 -no-pie att64c.c -o att64 -lm
